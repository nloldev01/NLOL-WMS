                  ...
                  <td className="px-6 py-3">
                    <div className="flex items-center justify-end gap-2">
                      <button
                        ...
                        className="rounded-md bg-orange-50 px-3 py-1.5 text-xs font-semibold text-orange-600 hover:bg-orange-100 transition-colors"
                      ...
                      <button
                        ...
                        className="rounded-md bg-slate-50 p-1.5 text-slate-600 hover:bg-slate-200 hover:text-orange-500 transition-colors"
