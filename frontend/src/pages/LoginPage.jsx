          ...
          <div className="w-full max-w-md">
            <div className="mb-8 text-center">
              <img
                ...
                alt="Logo"
              />
              <h1 className="mt-4 text-4xl font-bold text-gray-900">Great to see you again</h1>
              <p className="mt-1 text-base text-gray-500">Sign in to continue to NLOL WMS</p>
            </div>
